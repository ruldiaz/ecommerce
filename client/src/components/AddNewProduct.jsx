...
import { Tr, Td, Button, VStack, Textarea, Tooltip, Input, FormControl, Switch, FormLabel, Text, Badge } from "@chakra-ui/react";
  ...
  return (
    <Tr>
      ...
      <Td>
        ...
        <Textarea value={description} w='270px' h='120px' onChange={(e)=>setDescription(e.target.value)} placeholder='Description' size='sm' />
      </Td>
      <Td>
        <Text fontSize='sm'>
          Brand
